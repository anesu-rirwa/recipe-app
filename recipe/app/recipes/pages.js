...
export default function RecipePage() {
    ...
    useEffect(() => {
        ...
        try {
            const response = await fetch(`https://api.edamam.com/search?q=${recipeUri}&app_id=${process.env.NEXT_PUBLIC_APP_ID }&app_key=${process.env.NEXT_PUBLIC_APP_KEY}`);
            const data = await response.json();

            // assuming the response contains an array of recipes, you can choose the first one
